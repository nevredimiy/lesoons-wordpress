...
function shoper_options( $control ) {

	$shoper_defaults = array(
	...
	$shoper_defaults = wp_parse_args( get_option('shoper_options'), $shoper_defaults );

	// return control
	return $shoper_defaults[ $control ];
